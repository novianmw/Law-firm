        ...
        <div className="w-full h-full">
            <div className="flex flex-col md:flex-row justify-between md:justify-around items-center px-6 py-12 md:p-12">
                ...
                <div className="w-full flex flex-col items-start">
                    ...
                    <p className="pb-5 md:pr-14 text-lg md:text-xl text-black text-justify md:text-start">
                        the firm was established in 2007 in Jakarta, Indonesia As intellectual property law. Our exposure to the complexities in ambit
                        of intellectual property law give us the impetus spriration to diversity Into other streams. We are experienced in handling
                        international legal matters with empanelled with U.S consulate British Deputy High Commission.
                    </p>
                </div>
            </div>
        </div>

        ...
        <div className="w-full flex flex-col justify-center items-start px-6 md:px-12 py-5 h-full border-b-2 bg-indigo-900">
            <div className="w-full flex justify-between items-center">
                ...
                <nav className="md:flex hidden w-full justify-center items-center">
                    <ul className="flex justify-between list-none gap-5 lg:gap-10">
                        <a href="">
                            <li className="text-white border-b border-transparent hover:border-white hover:text-yellow-300">Home</li>
                        </a>
                        <a href="">
                            <li className="text-white border-b border-transparent hover:border-white hover:text-yellow-300">About</li>
                        </a>
                        <a href="">
                            <li className="text-white border-b border-transparent hover:border-white hover:text-yellow-300">Attorneys</li>
                        </a>
                        <a href="">
                            <li className="text-white border-b border-transparent hover:border-white hover:text-yellow-300">Practice Area</li>
                        </a>
                    </ul>
                </nav>
            ...
            <div className={`${toggle ? 'hidden' : 'md:flex hidden'} items-start justify-start md:justify-end pt-3 w-full`}>
                <form className="w-3/4 md:w-1/3" action="">
                    ...
                    <input
                        ...
                        name=""
                        id=""
                        className="flex border rounded-lg py-1 md:py-2 pl-4 pr-5 w-full shadow-sm"
            ...
            <nav className={`${toggle ? 'hidden' : 'flex md:hidden'} absolute left-0 top-[82px] z-10 w-full border-b-2 bg-indigo-900`}>
                <ul className="flex flex-col px-6 justify-between list-none py-5">
                    <a href="">
                        <li className="text-white hover:underline underline-offset-4 decoration-white hover:text-yellow-300">Home</li>
                    </a>
                    <a href="">
                        <li className="text-white hover:underline underline-offset-4 decoration-white hover:text-yellow-300">About</li>
                    </a>
                    <a href="">
                        <li className="text-white hover:underline underline-offset-4 decoration-white hover:text-yellow-300">Attorneys</li>
                    </a>
                    <a href="">
                        <li className="text-white hover:underline underline-offset-4 decoration-white hover:text-yellow-300">Practice Area</li>
                    </a>
